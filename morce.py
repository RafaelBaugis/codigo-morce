...
if __name__ == "__main__" :
    ...
    headlabel = Label(root, text = 'Welcome to Morse Code Translator', fg = 'black', bg = "light blue")
    label1 = Label(root, text = "One Language ", fg = 'black', bg = 'light green')
    label2 = Label(root, text = "From Language", fg = 'black', bg = 'light green')
    label3 = Label(root, text = "To Language ",  fg = 'black', bg = 'light green')
    label4 = Label(root, text = "Converted Language ", fg = 'black', bg = 'light green')
    ...
    button1 = Button(root, text = "Convert", bg = "light blue", fg = "black", command = convert)
    button1.grid(row = 4, column = 1, padx = 10, pady = 10)
    button2 = Button(root, text = "Clear", bg = "light blue", fg = "black", command = clearAll)
